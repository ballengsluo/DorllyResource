var App = function() {
    ...
    var handleMaterialDesign = function() {
        ...
        if ($('body').hasClass('page-md')) {
            ...
            // credit where credit's due; http://theidplayer.com/walkthrough/ripple-click-effect-google-material-design       
    ...
    var handleTabs = function() {
        ...
        if (location.hash) {
            var tabid = enidURI(location.hash.substr(1));
    ...
    return {
        ...
        // get layout color id by color name
...
$(function() {
    ...
    //除此之外全部关闭
    $(".dropdown-menu .tabCloseOther").click(function() {
