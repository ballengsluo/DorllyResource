...
$(function () {
    ...
    $("#del").on("click", function () {
        if (!choose || choose == "") {
            ...
            layer.confirm("是否删除？", function () {
                $.post("/Region/Delete", { id: choose }, function (data) {
...
function tableDblClick() {
    $(".table tr").dblclick(function () {
        ceOpen("/Region/Edit?id=" + $(this).find("#key").html());
    })
}

function refresh(param){
    $.get("/Region/Details", {cityCode:param},function (data) {
